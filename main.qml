...
Window {
    ...
    Control {
                ...
                delegate: Rectangle {
                    ...
                    Control {
                        ...
                        RoundButton {
                            ...
                            icon.source: "qrc:/icons/correct.png"
                            width: 40
                            height: 40
                            radius: 20
                            text: ""
        ...
        Label {
            ...
            text: "Найдено: " + amountFoundedItems
        }
        ...
        TextField {
            ...
            placeholderText: "Введите жанр для поиска"
        }
